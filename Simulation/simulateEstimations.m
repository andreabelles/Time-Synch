function [estIMURaw, estIntEKF, pGNSS, PEKF, estIntSkogHistoric, estIntSkogAtDelay, covSkogHistoric, covSkogAtDelay, measAcc, measGyro, xEKF, estIntPredPos] = ...
...
%     load('test.mat');
    ...
    [estIntEKF, PEKF(:,:,epoch), measAccCorrStandard(epoch), measGyroCorrStandard(epoch), xEKF(:,epoch), estIntPredPos(epoch, :)] =     ...
