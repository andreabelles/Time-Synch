function [estIMURaw, pGNSS, xEKF, PEKF, estEKF, xSkog, PSkog, estSkog, estSkogAtDelay, PSkogAtDelay] = ...
...
%     [estSkog, estSkogAtDelay, PSkog, PSkogAtDelay, measAccCorrSkog, measGyroCorrSkog] =         ...
%                                                 skogEKF(estSkog,  ...
%                                                         estSkogAtDelay,     ...
%                                                         PSkog,       ...
%                                                         PSkogAtDelay,          ...
