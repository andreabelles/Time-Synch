...
estEKF.biasGyro(k) = estEKF.biasGyro(k-1);
...
estEKF.biasAcc(k) = estEKF.biasAcc(k) - x(5); % Bias Acc correction
estEKF.biasGyro(k) = estEKF.biasGyro(k) - x(6); % Bias Gyro estimation 
